...
public class Breakout extends JFrame {
	...
	public static void main(String[] args) {
		...
		FeedforwardNeuralNetwork nn = FeedforwardNeuralNetwork.FNNfromFile(GeneticAlgorithm.INPUT_DIM, GeneticAlgorithm.HIDDEN_DIM, GeneticAlgorithm.OUTPUT_DIM, "best.txt");
